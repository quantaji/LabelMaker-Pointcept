...
data = dict(
    ...
    test=dict(
        ...
        test_cfg=dict(
            ...
            crop=None,
            post_transform=[dict(type="CenterShift", apply_z=False), dict(type="Add", keys_dict=dict(condition="ScanNet200")), dict(type="ToTensor"), dict(type="Collect", keys=("coord", "grid_coord", "index", "condition"), feat_keys=("color", "normal"))],
            aug_transform=[
