...
# rsync -r --ignore-existing -v -e ssh /mnt/LabelMaker/LabelMaker-Pointcept/data/scannetpp guangda@129.132.245.59:/home/guangda/repos/LabelMaker-Pointcept/data/scannetpp
